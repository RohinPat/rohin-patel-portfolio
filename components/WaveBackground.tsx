  ...
  return (
    <div className="fixed inset-0 overflow-hidden pointer-events-none opacity-30" style={{ zIndex: 0 }}>
      ...
      <motion.div
        ...
        style={{
          background:
            "radial-gradient(circle at 20% 50%, rgba(59, 130, 246, 0.3) 0%, transparent 50%), radial-gradient(circle at 80% 80%, rgba(168, 85, 247, 0.3) 0%, transparent 50%), radial-gradient(circle at 40% 20%, rgba(6, 182, 212, 0.3) 0%, transparent 50%)",
